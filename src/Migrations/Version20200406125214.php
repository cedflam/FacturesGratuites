 ...
 */
final class Version20200406125214 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE description (id INT AUTO_INCREMENT NOT NULL, devis_id INT DEFAULT NULL, prestation VARCHAR(1000) NOT NULL, date_prestation DATE DEFAULT NULL, quantite DOUBLE PRECISION DEFAULT NULL, unite VARCHAR(255) DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, tva DOUBLE PRECISION NOT NULL, montant DOUBLE PRECISION NOT NULL, motant_ttc DOUBLE PRECISION NOT NULL, INDEX IDX_6DE4402641DEFADA (devis_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, date_devis DATE NOT NULL, montant_ht DOUBLE PRECISION DEFAULT NULL, montant_ttc DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT DEFAULT NULL, client_id INT DEFAULT NULL, devis_id INT DEFAULT NULL, date_facture DATE NOT NULL, total_acompte DOUBLE PRECISION DEFAULT NULL, crd DOUBLE PRECISION DEFAULT NULL, montant_ht DOUBLE PRECISION NOT NULL, montant_ttc DOUBLE PRECISION NOT NULL, INDEX IDX_FE866410A4AEAFEA (entreprise_id), INDEX IDX_FE86641019EB6921 (client_id), UNIQUE INDEX UNIQ_FE86641041DEFADA (devis_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE acompte DROP FOREIGN KEY FK_CE996BEC7F2DEE08');
